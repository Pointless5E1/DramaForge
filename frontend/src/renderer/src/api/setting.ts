...
// 知識庫 API（request 已解包 ApiResponse<T>，此處直接返回 T）
...
// --- 提示詞 API ---
export interface Prompt { id: number; name: string; description: string; template: string; built_in?: boolean; is_review_prompt?: boolean }
