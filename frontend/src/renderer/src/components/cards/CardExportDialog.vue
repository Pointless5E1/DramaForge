    ...
    <el-form label-position="top">
      <el-form-item label="匯出範圍">
        <el-radio-group v-model="scope">
          ...
          <el-radio value="type">按類型</el-radio>
        </el-radio-group>
      </el-form-item>

      <el-form-item v-if="scope === 'single'" label="選擇卡片">
        <el-select v-model="selectedCardId" placeholder="請選擇卡片" filterable style="width: 100%">
          <el-option
            v-for="card in cards"
            :key="card.id"
      ...
      <el-form-item v-if="scope === 'type'" label="選擇卡片類型">
        <el-select v-model="selectedTypeId" placeholder="請選擇類型" style="width: 100%">
          <el-option
